...
class TestSparseCSR(TestCase):
    ...
    def test_sparse_mm_backward_half_precision(self, device, dtype):
        """
        Test that torch.sparse.mm backward works with half precision (fp16/bf16).
        This is a regression test for https://github.com/pytorch/pytorch/issues/144040
        """
        ...
        # Check gradients exist and have correct dtype
        self.assertIsNotNone(values.grad)
        self.assertIsNotNone(B.grad)
        self.assertEqual(values.grad.dtype, dtype)
        self.assertEqual(B.grad.dtype, dtype)

        # Verify gradients are correct by comparing with dense computation
